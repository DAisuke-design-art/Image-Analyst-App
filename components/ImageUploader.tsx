...
const ImageUploader: React.FC<ImageUploaderProps> = ({ onImageSelected, className = "h-64", label = "Paste Image" }) => {
  ...
  return (
    <div
      ...
      onPaste={handlePaste}
      onClick={handleClick}
      className={`relative w-full border-2 border-dashed rounded-xl flex flex-col items-center justify-center overflow-hidden transition-all cursor-pointer outline-none ${isFocused
